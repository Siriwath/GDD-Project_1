...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update() {
        ...
        */
        ...
        currDirection = PlayerRB.linearVelocity;
    ...
    IEnumerator AttackRoutine()
    {
        ...
        RaycastHit2D[] hits = Physics2D.BoxCastAll(PlayerRB.position + currDirection, new Vector2(2,2), 0f, Vector2.zero);
    ...
    private void Interact()
    {
         ...
         foreach(RaycastHit2D hit in hits)
        {
            if (hit.collider.CompareTag("Chest")){
                Chest cs = hit.collider.GetComponent<Chest>();
                cs.Open();
            }
        }
